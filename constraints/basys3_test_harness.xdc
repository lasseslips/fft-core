...
## Switches
set_property PACKAGE_PIN V17 [get_ports io_startTest]					
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports io_testComplete]					
set_property PACKAGE_PIN E19 [get_ports io_ledPass]					
set_property PACKAGE_PIN U19 [get_ports io_ledFail]					
set_property PACKAGE_PIN V19 [get_ports io_fftProcessing]					
set_property PACKAGE_PIN W18 [get_ports io_comparisonDone]					
#set_property PACKAGE_PIN U15 [get_ports {io_bcd_bits[6]}]					
set_property PACKAGE_PIN U14 [get_ports {io_currentTestIndex[0]}]					
set_property PACKAGE_PIN V14 [get_ports {io_currentTestIndex[1]}]					
set_property PACKAGE_PIN V13 [get_ports {io_currentTestIndex[2]}]					
